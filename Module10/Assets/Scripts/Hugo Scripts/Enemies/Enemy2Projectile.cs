...
// Description:         Projectile used by Enemy2 - "Thrown" at player from a distance using Launch()
...
public class Enemy2Projectile : MonoBehaviour
{
    ...
    [SerializeField]    private float explosionRadius = 5f;       // Blast radius of explosion (if within radius, player will be hurt)
    [SerializeField]    private float explosionDamage = 0.2f;     // Amount of damage done if caught in blast radius
